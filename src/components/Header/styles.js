...
//TweenMax.to($("#rotating-services"),.8,{text:{value:"Development Management",delimiter:""},delay:2})
/* 
...
tl.to(text, 0.8, {
  text: {
    value: "engaging & insightful words",
    padSpace: true,
...
var preloader = new GSPreloader({
  ...
  dotSize:15, 
  dotCount:10, 
  colors:["#f7d700","#f7383d","#5ee37a","#ff368b","#f77d01"], //have as many or as few colors as you want.
  boxOpacity:0.2,
